...
OPENAI_CHAT_API_URL = os.getenv("OPENAI_CHAT_API_URL", "https://api.openai.com/v1/chat/completions")
OPENAI_TTS_API_URL = os.getenv("OPENAI_TTS_API_URL", "https://api.openai.com/v1/audio/speech")
...
AUDIO_EXTENSIONS = tuple(os.getenv("AUDIO_EXTENSIONS", ".mp3,.m4a,.wav,.flac").split(","))